...
import { EIP155_SIGNING_METHODS } from '@web-examples/shared'
...
import { TRON_SIGNING_METHODS } from '@web-examples/shared'
import ModalStore from '@/store/ModalStore'
import SettingsStore from '@/store/SettingsStore'
import { walletkit } from '@/utils/WalletConnectUtil'
import { SignClientTypes } from '@walletconnect/types'
import { useCallback, useEffect, useMemo } from 'react'
import { NEAR_SIGNING_METHODS } from '@web-examples/shared'
...
import { BIP122_SIGNING_METHODS } from '@web-examples/shared'
...
import { TON_SIGNING_METHODS } from '@web-examples/shared'
