...
import { COSMOS_MAINNET_CHAINS, COSMOS_SIGNING_METHODS } from '@web-examples/shared'
import { KADENA_CHAINS, KADENA_SIGNING_METHODS } from '@web-examples/shared'
import { MULTIVERSX_CHAINS, MULTIVERSX_SIGNING_METHODS } from '@web-examples/shared'
import { NEAR_CHAINS, NEAR_SIGNING_METHODS } from '@web-examples/shared'
import { POLKADOT_CHAINS, POLKADOT_SIGNING_METHODS } from '@web-examples/shared'
import { SOLANA_CHAINS, SOLANA_SIGNING_METHODS } from '@web-examples/shared'
import { TEZOS_CHAINS, TEZOS_SIGNING_METHODS } from '@web-examples/shared'
import { TRON_CHAINS, TRON_SIGNING_METHODS } from '@web-examples/shared'
...
import { SUI_CHAINS, SUI_EVENTS, SUI_SIGNING_METHODS } from '@web-examples/shared'
import { suiAddresses } from '@/utils/SuiWalletUtil'
import { STACKS_CHAINS, STACKS_EVENTS, STACKS_SIGNING_METHODS } from '@web-examples/shared'
...
import { TON_CHAINS, TON_SIGNING_METHODS } from '@web-examples/shared'
