...
import { NEAR_CHAINS, NEAR_TEST_CHAINS, TNearChain } from '@web-examples/shared'
import { POLKADOT_CHAINS, TPolkadotChain } from '@web-examples/shared'
import { SOLANA_CHAINS, TSolanaChain } from '@web-examples/shared'
import { TEZOS_CHAINS, TTezosChain } from '@web-examples/shared'
import { TRON_CHAINS, TTronChain } from '@web-examples/shared'
import { KADENA_CHAINS, TKadenaChain } from '@web-examples/shared'
import { TON_CHAINS } from '@web-examples/shared'
