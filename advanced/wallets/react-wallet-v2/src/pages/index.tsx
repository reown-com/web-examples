...
import { COSMOS_MAINNET_CHAINS } from '@web-examples/shared'
import { EIP155_MAINNET_CHAINS, EIP155_TEST_CHAINS } from '@web-examples/shared'
import { SOLANA_MAINNET_CHAINS, SOLANA_TEST_CHAINS } from '@web-examples/shared'
import { POLKADOT_MAINNET_CHAINS, POLKADOT_TEST_CHAINS } from '@web-examples/shared'
import { MULTIVERSX_MAINNET_CHAINS, MULTIVERSX_TEST_CHAINS } from '@web-examples/shared'
import { TRON_MAINNET_CHAINS, TRON_TEST_CHAINS } from '@web-examples/shared'
import { NEAR_TEST_CHAINS } from '@web-examples/shared'
import { TEZOS_MAINNET_CHAINS, TEZOS_TEST_CHAINS } from '@web-examples/shared'
import { KADENA_MAINNET_CHAINS, KADENA_TEST_CHAINS } from '@web-examples/shared'
...
import { BIP122_CHAINS } from '@web-examples/shared'
import { useRouter } from 'next/router'
import ChainAbstractionBalanceCard from '@/components/ChainAbstractionBalanceCard'
import { SUI_MAINNET, SUI_MAINNET_CHAINS, SUI_TESTNET_CHAINS } from '@web-examples/shared'
import { STACKS_MAINNET, STACKS_TESTNET } from '@web-examples/shared'
