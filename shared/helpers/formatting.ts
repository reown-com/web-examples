/**
 * Formatting utilities for text, addresses, and data
...
/**
 * Ellipse text to a maximum length
 */
...
/**
 * Ellipse an address for display
 */
...
/**
 * Convert amount to Wei/atomic units
 */
...
/**
 * Convert Wei/atomic units to human-readable format
 */
...
/**
 * Get data string for contract calls
 */
